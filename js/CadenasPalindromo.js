...
function mostrar(){
  document.getElementsByClassName('etiqueta')[0].innerHTML=(palindromo("La ruta nos aporto otro paso natural"));
  document.getElementsByClassName('etiqueta')[1].innerHTML=(palindromo("Esta frase no se parece a ningun palindromo"));
}
