...
var sValorCal="";
			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						nCalif++;
							sValorCapturado = document.getElementById("txtResultado"+i).style="border: 2px solid #4bf510; background-color: #4bf510";
					}

					 else
						 sValorCapturado = document.getElementById("txtResultado"+i).style="border: 2px solid #ff0000; background-color: #ff0000";
	...
	if (sErr == "")
	   	document.getElementById("lab").innerHTML='Calificacion: '+nCalif;
	else
		document.getElementById("lab").innerHTML=sErr;
}
